...
export const meta = {
	...
	description:
		"The menu is a list of options that users can select to perform different tasks in a software. You can click the Menu Icon on the top left corner to open the Menu. In this section, we will introduce the menu in CHITUBOX.",
