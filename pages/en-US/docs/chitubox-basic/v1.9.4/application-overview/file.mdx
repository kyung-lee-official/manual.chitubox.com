...
export const meta = {
	...
	pageId: "/en-US/chitubox-basic/v1.9.4/file",
	description:
...
<AntdImage src={"/images/docs/en-US/chitubox-basic/1.x.x/006-file-4.png"} />
...
<AntdImage src={"/images/docs/en-US/chitubox-basic/1.x.x/006-file-2.png"} />
...
<AntdImage src={"/images/docs/en-US/chitubox-basic/1.x.x/006-file-1.png"} />

## Quit

Quit the CHITUBOX.

<AntdImage src={"/images/docs/en-US/chitubox-basic/1.x.x/006-file-3.png"} />
