...
<ImageContainer>
	<StyledAntdImage
		src={
			"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-001.png"
		}
	/>
</ImageContainer>
...
1. 其他文件更新 <br />
   随后主板会自动对剩余的文件进行更新（UI 文件、logo 文件除外），并显示更新进度情况，当所有待更新的文件更新完成后，程序将弹出【打印完成】的提示框。 <br />
    ...
    <StyledAntdImage
    	src={
    		"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-002.png"
    	}
    />
    ...
    <StyledAntdImage
    	src={
    		"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-003.png"
    	}
    />
...
<StyledAntdImage
	src={
		"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-004.png"
	}
/>
...
<StyledAntdImage
	src={
		"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-005.png"
	}
/>
...
<StyledAntdImage
	src={
		"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-006.png"
	}
/>
...
<p>
	<StyledAntdImage
		src={
			"/images/docs/zh-CN/chitubox-pro/004-setting-up-update-printer-firmware-007.png"
		}
		style={{ width: 50 }}
	/>{" "}
	此图标后的信息显示的是当前固件的版本。
