	...
	return (
		<main>
			...
			>
				...
				>
					<Link
						href={`/${locale}/docs/chitubox-basic/latest/introduction`}
					>
				...
				>
					<Link
						href={`/${locale}/docs/chitubox-pro/latest/introduction`}
					>
				...
				>
					<Link
						href={`/${locale}/docs/chitu-manager/latest/introduction`}
					>
				...
				>
					<Link
						href={`/${locale}/docs/faq/latest/chitubox-basic-faq`}
					>
						{t("footer.faqDoc")}
					</Link>
				</motion.button>
