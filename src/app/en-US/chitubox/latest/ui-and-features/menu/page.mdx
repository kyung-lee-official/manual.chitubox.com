...
<ImageContainer
	src={
		"/images/docs/en-US/chitubox-basic/2.x.x/en-maclog-001.png"
	}
/>

<ImageContainer
	src={
		"/images/docs/en-US/chitubox-basic/2.x.x/en-maclog-002.png"
	}
/>
...
<ImageContainer
	src={
		"/images/docs/en-US/chitubox-basic/2.x.x/en-maclog-003.png"
	}
/>
...
<ImageContainer
	src={
		"/images/docs/en-US/chitubox-basic/2.x.x/en-maclog-004.png"
	}
/>

<ImageContainer
	src={
		"/images/docs/en-US/chitubox-basic/2.x.x/en-maclog-005.png"
	}
/>
...
<Admonition type="note">
	The cache path of macOS can't be located for now as the its location is dynamic.
</Admonition>
...
On Windows, you can choose Direct3D or OpenGL as the rendering engine.

On macOS, you can choose Metal or OpenGL as the rendering engine.
