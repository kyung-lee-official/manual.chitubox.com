...
<Entry
	supportSettingsPanel={["Auto Support", "Add Auto Support"]}
	shortcut={["Shift", "S"]}
/>
...
Manually or automatically add supports to overhang areas after running <Link href="/en-US/chitubox-pro/latest/risk-detection#overhang-detection">Overhang Detection</Link> can prevent overhangs from deforming or breaking during printing.
