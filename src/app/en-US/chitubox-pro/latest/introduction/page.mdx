...
**Multiple Risk Detections**: CHITUBOX Pro provides multiple <NextLink href="/en-US/chitubox-pro/latest/risk-detection">Risk Detection</NextLink> functions, such as cavity detection, clash detection and overhang detection.

**Convenient Automated Functions**: CHITUBOX Pro provides <NextLink href="/en-US/chitubox-pro/latest/chitu-action">ChituAction</NextLink> and <NextLink href="/en-US/chitubox-pro/latest/support/magic-support">Magic Supports</NextLink> which allow you to script and execute the model processing workflow and automate custom support creation.
