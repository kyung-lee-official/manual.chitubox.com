...
Anti-aliasing has two modes: **Gray Scale Level** and **Anti-aliasing Level**。
...
_Gray Scale Unit_: click <NextLink href="#灰度单位">here</NextLink> to learn more about gray scale unit.
