...
<Admonition type="note" title="Note">
	Only some printers support **Resting Time** waiting mode. Read the <SpanA href="https://wkhvloo2kw.feishu.cn/docx/Q5nbdGSnfo5EbAxgEwKccN0Rnxe">📃full compatible list</SpanA> here.
</Admonition>
...
_Mask File_: You can select an existing image by clicking the `...` icon, or click the gear icon to create a new one using CHITUBOX's built-in <NextLink href="#mask-generator">mask generator</NextLink>.

_Gray Scale Unit_: click <NextLink href="#gray-scale-unit">here</NextLink> to learn more about gray scale unit.
