...
<Entry profileList={["Double Click a Configuration File"]} slicePanel={["Slice Settings"]} />
...
<Admonition type="note" title="Note">
	Only some printers support **Resting Time** waiting mode. Read the <Link href="https://wkhvloo2kw.feishu.cn/docx/Q5nbdGSnfo5EbAxgEwKccN0Rnxe">📃full compatible list</Link> here.
</Admonition>
