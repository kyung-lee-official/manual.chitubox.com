...
Add a printer before configure your print parameters. See <Link href="/en-US/chitubox-pro/v1.4.1/application-overview/start#add-machine">here</Link> on how to add a printer.
...
Open <Link href="https://youtu.be/ihITNQetn94">📺this video</Link> and <Link href="https://www.chitubox.com/en/article/academy/advanced/pre-/52">📃this article</Link> to learn more about **Anti-aliasing**, **Grayscale**, and **Image Blur**.
...
Open <Link href="https://youtu.be/iYKVPmmoUUo">📺this video</Link> and <Link href="https://www.chitubox.com/en/article/academy/tutorial/chitubox-free/manual/how-to-use-tolerance-compensation-on-chitubox">📃this article</Link> to learn more about **Tolerance Compensation**.
...
_Mask File_ : You can select an existing image by clicking `...` icon or create a new one using CHITUBOX's built-in <Link href="#91-mask-generator">mask generator</Link> by clicking the gear icon.

_Gray scale unit_ : click <Link href="#92-gray-scale-unit">here</Link> to learn more about gray scale unit.
...
<Admonition type="note">
	Learn more about **Mirror** <Link href="https://www.chitubox.com/docs/en-US/chitubox/howto/chitubox-free/slicing/44">📃here</Link>. <br />
