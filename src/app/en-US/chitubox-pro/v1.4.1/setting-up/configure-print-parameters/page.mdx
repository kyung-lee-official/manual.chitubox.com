...
Add a printer before configure your print parameters. See <Link href="/en-US/chitubox-pro/latest/application-overview/start#add-machine">here</Link> on how to add a printer.
