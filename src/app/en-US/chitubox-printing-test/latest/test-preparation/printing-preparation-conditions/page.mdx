...
Detailed printing parameter setting instructions can be seen on <Link href="https://manual.chitubox.com/en-US/chitubox-pro/latest/setting-up/configure-print-parameters">📖user manual</Link>.
...
<ResponsiveTable>
	...
	<tbody>
		<tr>
			...
			<td>Mirror</td>
			<td>
				Mirror settings affect the symmetry of the print file. Click <Link href="https://www.chitubox.com/en/academy/tutorials/chitubox-basic/manual/guide-for-mirror-parameters-in-chitubox"> 📖 here </Link> to learn more.
			</td>
		</tr>
		<tr>
			<td>Resolution</td>
