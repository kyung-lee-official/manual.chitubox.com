...
| -------------------------- | -------------------- | ---------------------------------------------------------------------- |
| CHITUBOX Project File 2023 | \*.ctp               | Contains more model info (position, rotation, etc., and larger file size)                                              |
...
| Configuration Files | \*.cfg               | Contains printer configuration information and support configuration information |import { exitCode } from "process";
