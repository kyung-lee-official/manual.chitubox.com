...
Light <Link href="https://en.wikipedia.org/wiki/Pulse-width_modulation">PWM</Link> for bottom layers, ranging from `0` to `255` or from `0%` to `100%`, controls the power of the UV light source for bottom layers.

### Light PWM

Light <Link href="https://en.wikipedia.org/wiki/Pulse-width_modulation">PWM</Link> for normal layers, ranging from `0` to `255` or from `0%` to `100%`, controls the power of the UV light source for normal layers.
