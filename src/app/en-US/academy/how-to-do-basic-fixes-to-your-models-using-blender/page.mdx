export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/cover.png",
		],
	},
};
...
<ImageContainer>
	<AntdImage
		alt="open structures"
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/open-structures.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/inverted-normal-fragments-inside-the-cube.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="slice result"
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/slice-result-01.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="slice result"
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/slice-result-02.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/edit-mode.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/face-orientation-option.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/flip-selected-faces.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/openenclosed-structure-semi-sphere.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/3-selection-modes.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/use-edge-select-mode-to-fix-the-model.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/solidify-the-semi-sphere.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="stripe patterns"
		src={
			"/images/docs/en-US/academy/how-to-do-basic-fixes-to-your-models-using-blender/stripe-patterns.png"
		}
	/>
</ImageContainer>
