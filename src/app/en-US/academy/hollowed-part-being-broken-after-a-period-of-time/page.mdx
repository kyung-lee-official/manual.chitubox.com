export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/academy/hollowed-part-being-broken-after-a-period-of-time/cover.png",
		],
	},
};
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/hollowed-part-being-broken-after-a-period-of-time/a-broken-hollow-model.jpg"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/images/docs/en-US/academy/hollowed-part-being-broken-after-a-period-of-time/unclean-inner-wall-01.jpg"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="the inner wall is not clean enough"
		src={
			"/images/docs/en-US/academy/hollowed-part-being-broken-after-a-period-of-time/unclean-inner-wall-02.jpg"
		}
	/>
</ImageContainer>
