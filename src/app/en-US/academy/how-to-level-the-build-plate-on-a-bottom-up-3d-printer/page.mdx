export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/cover.png",
		],
	},
};
...
<BlogImageContainer
	...
	src={
		"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/uneven-raft-and-thicker-raft.jpg"
	}
/>
...
-   Press the Z height reset button on the screen to lower the build plate until it goes for home position at the correct height
    <BlogImageContainer
		...
		src={
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/manual-button-on-the-printer.png"
		}
	/>
   ...
   <BlogImageContainer
		alt="z height"
		src={
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/z-height.png"
		}
	/>
...
-   Hold the build plate and loosen the leveling screws
    <BlogImageContainer
		...
		src={
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/hold-the-build-plate-and-loosen-the-leveling-screws.gif"
		}
	/>
...
-   Reduce the lowering distance unit (0.1mm/1mm), and continue to lower the build platform until you feel resistance from the entire plane, not just a corner, when you try to move the paper.
    <BlogImageContainer
		...
		src={
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/moving-the-paper.gif"
		}
	/>
...
-   Back to the home screen and click "Set Z=0"
    <BlogImageContainer
		alt="Set Z=0 button"
		src={
			"/images/docs/en-US/academy/how-to-level-the-build-plate-on-a-bottom-up-3d-printer/set-z0-button.png"
		}
	/>