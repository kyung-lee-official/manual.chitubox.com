export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/academy/effects-of-layer-height-on-sladlplcd-3d-printing/cover.png",
		],
	},
};
...
<BlogImageContainer footnote={"Layer height: 0.2mm"}
	alt="a cylinder with layer height of 0.2mm"
	src={
		"/images/docs/en-US/academy/effects-of-layer-height-on-sladlplcd-3d-printing/a-cylinder-with-layer-height-of-02mm.jpg"
	}
/>
...
<BlogImageContainer
		...
		src={
			"/images/docs/en-US/academy/effects-of-layer-height-on-sladlplcd-3d-printing/different-layer-heights-of-the-cylinder.jpg"
		}
/>
...
<BlogImageContainer
	...
	src={
		"/images/docs/en-US/academy/effects-of-layer-height-on-sladlplcd-3d-printing/the-effect-of-different-layer-heights-on-printing.jpg"
	}
/>
