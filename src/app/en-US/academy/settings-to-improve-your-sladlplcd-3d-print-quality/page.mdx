export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/cover.png",
		],
	},
};
...
<BlogImageContainer footnote="Left: 100µm layer thickness   Right: 50µm layer thickness"
	alt="hemisphere with different layer heights"
	src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/hemisphere-with-different-layer-heights.png"
	}
/>
...
<BlogImageContainer
	alt="layer height"
	src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/layer-height.png"
	}
/>
...
<BlogImageContainer
	alt="exposure time"
	src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/exposure-time.png"
	}
/>
...
<BlogImageContainer
	...
	src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/different-orientations.png"
	}
/>
...
<BlogImageContainer
	...
	src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/disableenable-antialiasing.png"
	}
/>
...
<ImageComparison
	img1Src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/blur-level-2.png"
	}
	text1={"Level-2 Image Blur"}
	img2Src={
		"/images/docs/en-US/academy/settings-to-improve-your-sladlplcd-3d-print-quality/blur-level-8.png"
	}
