...
1. Open the folder where CHITUBOX Pro stores the cache: C:\Users\Username\AppData\Local\CHITUBOX Pro.

1. Close CHITUBOX Pro (**Make sure to close CHITUBOX Pro before proceeding**).

1. Then back up the 📁*3995433653* folder inside the 📁*CHITUBOX Pro* by copying it to another location. After backing up, you can delete the entire 📁*CHITUBOX Pro* folder to clear the cache.

<ImageContainer
	src={
		"/images/docs/en-US/faq/chitubox-pro/1.x.x/faq-clearcache-en.png"
	}
/>

Restart CHITUBOX Pro—a new 📁*CHITUBOX Pro*  folder will be automatically generated. If you need to save your slicing and support settings, it's best to upload them to the cloud before clearing the cache.

<Admonition type="note" title="Note">
	📁*3995433653* folder contains your machine settings, appearance preferences, shortcut configurations and etc. Backing up this folder helps retain your important configuration files. However, if the issue you're facing is due to a corrupted configuration file, restoring this folder may not resolve the problem.
	Do not copy all the backed-up configuration files directly into the new 📁*CHITUBOX Pro* folder, as the issue may have been caused by one of these files.
</Admonition>
...
<ImageContainer
	src={"/images/docs/en-US/faq/chitubox-basic/2.x.x/FAQ-thumbnails-en001.png"}
/>
...
<ImageContainer
	src={"/images/docs/en-US/faq/chitubox-basic/2.x.x/FAQ-thumbnails-en002.png"}
/>
...
<ImageContainer
	src={"/images/docs/en-US/faq/chitubox-basic/2.x.x/FAQ-thumbnails-en003.png"}
/>
<ImageContainer
	src={"/images/docs/en-US/faq/chitubox-basic/2.x.x/FAQ-thumbnails-en004.png"}
/>
...
<ImageContainer
	src={"/images/docs/en-US/faq/chitubox-basic/2.x.x/FAQ-thumbnails-en005.png"}
/>
