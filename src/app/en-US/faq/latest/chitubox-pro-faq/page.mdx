...
<Admonition type="note">
	Please make sure you've installed all <Link href="/en-US/chitubox-pro/latest/requirements">required environments</Link>.
</Admonition>
...
1. Open the log path (Setting/Help > Open Log). <Link href="/en-US/chitubox-pro/latest/application-overview/setting-and-help#open-log">📃Click here</Link> to learn how to open the log.
