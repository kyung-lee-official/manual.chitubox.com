...
<ImageContainer footnote="只有支撑被打印出来">
	<AntdImage
...
<ImageContainer footnote="粘在 FEP 膜上">
	<AntdImage
...
<ImageContainer footnote="分层或有气泡">
	<AntdImage
		alt="Laminaria-like layers or bubbles"
		src={
