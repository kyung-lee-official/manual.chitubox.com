...
export const Warning = ({ size, fill }: any) => {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
		>
			<path d="M13.3455 0.429219C14.0919 0.0100489 14.968 -0.107482 15.7969 0.100364C16.6257 0.308209 17.3456 0.825942 17.8111 1.549L17.946 1.76085L29.5745 22.9459C29.8517 23.4489 29.9981 24.0146 30 24.5903C30.0019 25.1659 29.8592 25.7327 29.5853 26.2375C29.3113 26.7423 28.9151 27.1688 28.4337 27.477C27.9522 27.7853 27.4012 27.9652 26.8322 28H3.36533C2.80047 27.9989 2.24492 27.8546 1.74971 27.5802C1.2545 27.3058 0.835488 26.9101 0.531164 26.4296C0.22684 25.949 0.0469518 25.399 0.00801889 24.8299C-0.030914 24.2609 0.0723561 23.6911 0.308346 23.1728L0.413243 22.961L12.0418 1.76085C12.3415 1.20096 12.791 0.746994 13.3605 0.429219H13.3455ZM14.9939 20.4339C14.5964 20.4339 14.2153 20.5933 13.9343 20.8771C13.6532 21.1609 13.4954 21.5458 13.4954 21.9471C13.4954 22.3485 13.6532 22.7334 13.9343 23.0171C14.2153 23.3009 14.5964 23.4604 14.9939 23.4604C15.3913 23.4604 15.7725 23.3009 16.0535 23.0171C16.3345 22.7334 16.4924 22.3485 16.4924 21.9471C16.4924 21.5458 16.3345 21.1609 16.0535 20.8771C15.7725 20.5933 15.3913 20.4339 14.9939 20.4339ZM14.9939 8.3282C14.6257 8.32552 14.2695 8.45978 13.9931 8.70539C13.7167 8.95099 13.5395 9.29074 13.4954 9.65983V17.5891C13.4954 17.9904 13.6532 18.3753 13.9343 18.6591C14.2153 18.9429 14.5964 19.1023 14.9939 19.1023C15.3913 19.1023 15.7725 18.9429 16.0535 18.6591C16.3345 18.3753 16.4924 17.9904 16.4924 17.5891V9.65983C16.4482 9.29074 16.2711 8.95099 15.9947 8.70539C15.7183 8.45978 15.362 8.32552 14.9939 8.3282Z" />
		</svg>
	);
};
...
export const Dangerous = ({ size, fill }: any) => {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
		>
			<path d="M21.2167 0H8.78333L0 8.78333V21.2167L8.78333 30H21.2167L30 21.2167V8.78333L21.2167 0ZM23.3333 21.2333L21.2333 23.3333L15 17.1L8.76667 23.3333L6.66667 21.2333L12.9 15L6.66667 8.76667L8.76667 6.66667L15 12.9L21.2333 6.66667L23.3333 8.76667L17.1 15L23.3333 21.2333Z" />
		</svg>
	);
};
