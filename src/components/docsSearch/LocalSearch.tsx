...
const DynamicLocalSearchResult = dynamic(
	() => import("@/components/docsSearch/LocalSearchResult"),
	{
		ssr: false,
	}
);
		...
		return (
			<div className="relative flex justify-center items-center">
				...
				>
					...
					<DynamicLocalSearchResult searchResults={searchResults} />
				</div>
			</div>
		);
	} else {
