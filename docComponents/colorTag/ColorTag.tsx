...
export const ColorTag: React.FC<any> = ({ start, end = 255 }) => {
	return (
		<div
			style={{
				height: "1.5rem",
...
// export const GrayScaleConverter: React.FC<any> = ({ language }) => {
...
//       <thead>
//         <tr>
//           <th>Basic ({language === "zh" ? "灰度级别" : "Gray Level"} )</th>
//           <th>Pro ({language === "zh" ? "灰度范围" : "Gray Range"})</th>
